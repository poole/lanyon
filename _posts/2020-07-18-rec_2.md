...
- **Sparsity Problem**
: 유저와 아이템 개수가 급증할 수록, ***유저가 실제 소비한 아이템의 비율은 점점 줄어듦***
→ 추천 피드백 정보가 희박해짐
...
그러나 User-based & Item-based  둘다 유사도 계산 과정에서 반대편 정보를 압축하는 과정이 발생하기에 정보 손실이 발생
...
- Prediction : $\hat{r}_{ui} = x_u^T\cdot y_i = \sum x_{uk}y_{ki}$
- Loss function : $L = \sum(r_{ui} - x_u^T \cdot y_i)^2 +( \lambda_x\sum_u ||x_u||^2 +\lambda_x\sum_u ||y_i||^2)$
...
![https://s3-us-west-2.amazonaws.com/secure.notion-static.com/9b5ae7f7-3d43-4131-8691-ca2c5ab53a68/_2020-07-15__12.12.43.png](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/9b5ae7f7-3d43-4131-8691-ca2c5ab53a68/_2020-07-15__12.12.43.png)
...
![https://s3-us-west-2.amazonaws.com/secure.notion-static.com/afd2fd72-52c6-4e02-a9fe-57232af2d873/_2020-07-15__12.25.52.png](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/afd2fd72-52c6-4e02-a9fe-57232af2d873/_2020-07-15__12.25.52.png)
