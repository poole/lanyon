...
`![ICLR LOGO]({{ site.url }}/public/images/example_content_jdoe/ICLR-logo.png)` becomes:
...
Here, `\{% include example_content_jdoe/plotly_demo_1.html %}` (without the `\` prefix) becomes
